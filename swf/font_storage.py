...
class FontStorage:
    ...
    def __init__(self, font_store_dir: str) -> None:
        self._font_store_dir = font_store_dir
        self._fonts = self._get_available_fonts()

    def _get_available_fonts(self) -> Dict[str, 'Font']:
        fonts = {}
        if not os.path.exists(self._font_store_dir):
            return fonts
        for filename in os.listdir(self._font_store_dir):
            font_dir = os.path.join(self._font_store_dir, filename)
    ...
    def _get_font_path(self, font_name: str) -> str:
        return os.path.join(self._font_store_dir, font_name)
